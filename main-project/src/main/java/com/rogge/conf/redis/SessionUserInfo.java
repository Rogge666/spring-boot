...
public class SessionUserInfo {
	 ...
	 */
	public String getSessionUserKey(String userType, String userId) {
	...
	public <T extends SessionUser> T getSessionUser(HttpSession session, Class<T> clazz) {
		...
		String userId = (String) session.getAttribute(getSessionUserIdKey(getUserType(clazz)));
		if (userId != null) {
	 ...
	 * 根据id获取用户信息
	 */
	public <T extends SessionUser> T getSessionUser(String userId, Class<T> clazz) {
		if (userId != null) {
			return redisDao.get(getSessionUserKey(getUserType(clazz), userId), clazz);
		}
		return null;
